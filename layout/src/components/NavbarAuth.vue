        ...
        <header class="absolute inset-x-0 top-0 z-50">
          <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
              <a v-for="item in navigation" :key="item.name" :href="item.href" class="text-xl font-semibold leading-6 text-gray-900">{{ item.name }}</a>
            </div>
            ...
            <div class="hidden lg:flex lg:justify-end">
              <span class="bg-gray-400 h-14 w-14 rounded-full inline-flex items-center justify-center">
                <span class="text-xl font-medium leading-none text-white">AS</span>
              </span>  
            </div>
          </nav>
