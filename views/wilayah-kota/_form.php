...
<div class="d-flex  flex-wrap">
	...
	<?=         // modified by Defri Indra
        $form->field($model, 'provinsi_id', \app\components\Constant::COLUMN())->widget(\kartik\select2\Select2::className(), [
            'name' => 'class_name',
            'model' => $model,
            'attribute' => 'provinsi_id',
            'data' => \yii\helpers\ArrayHelper::map(app\models\WilayahProvinsi::find()->all(), 'id', 'nama'),
            'options' => [
                'placeholder' => $model->getAttributeLabel('provinsi_id'),
                'multiple' => false,
                'disabled' => (isset($relAttributes) && isset($relAttributes['provinsi_id'])),
            ]
        ]); ?>
