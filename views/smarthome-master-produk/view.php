...
$this->title = Yii::t('cruds', 'Smarthome Master Produk') . ' : ' . $model->id;
?>
<div class="giiant-crud smarthome-master-produk-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="fa fa-list"></span> ' . Yii::t('cruds', 'Daftar Smarthome Master Produk'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    <?php endif ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                <?php endif ?>
                    <?php $this->beginBlock('app\models\SmarthomeMasterProduk'); ?>
            ...
            'format' => 'iddate',
                    ...
                    [
                        ...
                        'content' => $this->blocks['app\models\SmarthomeMasterProduk'],
                        'active'  => true,
                    ],
                        ]
                    ]);
