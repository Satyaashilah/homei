 ...
 * @var app\models\search\SmarthomeMasterProdukSearch $searchModel
 */

$this->title = Yii::t('cruds', 'Smarthome Master Produk');
                ...
                <div class="table-responsive">
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            \app\components\ActionAjaxButton::getButtons(['template' => '{view} {update}'], "smarthome-master-produk"),
