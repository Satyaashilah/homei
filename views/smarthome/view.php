...
$this->title = Yii::t('cruds', 'Smarthome') . ' : ' . $model->nama;
?>
<div class="giiant-crud smarthome-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="fa fa-list"></span> ' . Yii::t('cruds', 'Daftar Smarthome'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    <?php endif ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                <?php endif ?>
                    <?php $this->beginBlock('app\models\Smarthome'); ?>
            ...
            'format' => 'text',
					        ...
					        [
            'attribute' => 'daya_sebelumnya',
            'format' => 'text',
        ],
					        [
            'attribute' => 'ampere_sebelumnya',
            'format' => 'text',
        ],
					        [
            'attribute' => 'token',
            'format' => 'text',
                    ...
                    [
                        ...
                        'content' => $this->blocks['app\models\Smarthome'],
                        'active'  => true,
                    ],
                        ]
                    ]);
