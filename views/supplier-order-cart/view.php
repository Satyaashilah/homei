...
$this->title = Yii::t('cruds', 'Supplier Order Cart') . ' : ' . $model->id;
?>
<div class="giiant-crud supplier-order-cart-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="fa fa-list"></span> ' . Yii::t('cruds', 'Daftar Supplier Order Cart'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    <?php endif ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                <?php endif ?>
                    <?php $this->beginBlock('app\models\SupplierOrderCart'); ?>
            ...
            'format' => 'text',
                    ...
                    [
                        ...
                        'content' => $this->blocks['app\models\SupplierOrderCart'],
                        'active'  => true,
                    ],
                        ]
                    ]);
