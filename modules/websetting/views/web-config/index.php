 ...
 * @var app\modules\websetting\models\search\WebConfigSearch $searchModel
 */

$this->title = Yii::t('cruds', 'Web Config');
                ...
                <div class="table-responsive">
                    ...
                    <?= GridView::widget([
                        ...
                        'rowOptions' => function ($model) {
                            if ($model->active == false) return ['style' => 'background: rgba(255,0,0,.1)'];
                        },
                        'columns' => [

                            \app\components\ActionAjaxButton::getButtons(["template" => "{view} {update}"], "web-config"),
