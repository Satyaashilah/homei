 ...
 * @var app\modules\websetting\models\search\WebConfigGroupSearch $searchModel
 */

$this->title = Yii::t('cruds', 'Web Config Group');
                ...
                <div class="table-responsive">
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            \app\components\ActionAjaxButton::getButtons(["template" => "{view} {update}"], "web-config-group"),
