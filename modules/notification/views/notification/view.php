...
$this->title = 'Notification : ' . $model->title;
?>
<div class="giiant-crud notification-view">
    ...
    <p class="pull-right">
        <?= Html::a('<span class="fa fa-list"></span> ' . Yii::t('cruds', 'Daftar Notification'), ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    <?php endif ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card m-b-30">
                <div class="card-body">
                <?php endif ?>
                    <?php $this->beginBlock('app\modules\notification\models\Notification'); ?>
            ...
            'format' => 'iddate',
                    ...
                    [
                        ...
                        'content' => $this->blocks['app\modules\notification\models\Notification'],
                        'active'  => true,
                    ],
                        ]
                    ]);
