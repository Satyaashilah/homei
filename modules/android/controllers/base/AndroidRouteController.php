...
/**
 * AndroidRouteController implements the CRUD actions for AndroidRoute model.
 **/
class AndroidRouteController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\AndroidRouteValidation();
    }

    /**
     * Lists all AndroidRoute models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel  = new AndroidRouteSearch;
    ...
    /**
     * Creates a new AndroidRoute model.
    ...
    /**
     * Finds the AndroidRoute model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AndroidRoute the loaded model
     * @throws HttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AndroidRoute::findOne($id)) !== null) {
            return $model;
        } else {
