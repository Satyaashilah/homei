...
/**
 * AndroidBannerKategoriController implements the CRUD actions for AndroidBannerKategori model.
 **/
class AndroidBannerKategoriController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\AndroidBannerKategoriValidation();
    }

    /**
     * Lists all AndroidBannerKategori models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel  = new AndroidBannerKategoriSearch;
    ...
    /**
     * Creates a new AndroidBannerKategori model.
    ...
    {
        $render = $this->getRenderMethod();
        $model = new AndroidBannerKategori;
    ...
    /**
     * Finds the AndroidBannerKategori model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return AndroidBannerKategori the loaded model
     * @throws HttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = AndroidBannerKategori::findOne($id)) !== null) {
            return $model;
        } else {
