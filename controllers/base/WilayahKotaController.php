...
use app\models\search\WilayahKotaSearch;
 ...
 **/
class WilayahKotaController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\WilayahKotaValidation();
    }

    /**
    * Lists all WilayahKota models.
    * @return mixed
    */
    public function actionIndex()
    {
        $searchModel  = new WilayahKotaSearch;
    ...
    /**
    * Creates a new WilayahKota model.
    ...
    */
    ...
    /**
    * Finds the WilayahKota model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param string $id
    * @return WilayahKota the loaded model
    * @throws HttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (($model = WilayahKota::findOne($id)) !== null) {
            return $model;
        } else {
