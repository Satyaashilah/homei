...
use app\models\search\WilayahDesaSearch;
...
/**
 * WilayahDesaController implements the CRUD actions for WilayahDesa model.
 **/
class WilayahDesaController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\WilayahDesaValidation();
    }

    /**
    * Lists all WilayahDesa models.
    * @return mixed
    */
    public function actionIndex()
    {
        $searchModel  = new WilayahDesaSearch;
    ...
    /**
    * Creates a new WilayahDesa model.
    ...
    */
    ...
    /**
    * Finds the WilayahDesa model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param string $id
    * @return WilayahDesa the loaded model
    * @throws HttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (($model = WilayahDesa::findOne($id)) !== null) {
            return $model;
        } else {
