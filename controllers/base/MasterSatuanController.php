...
/**
 * MasterSatuanController implements the CRUD actions for MasterSatuan model.
 **/
class MasterSatuanController extends \app\components\productive\DefaultActiveController
{
