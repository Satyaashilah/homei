...
use app\models\search\WilayahProvinsiSearch;
...
/**
 * WilayahProvinsiController implements the CRUD actions for WilayahProvinsi model.
 **/
class WilayahProvinsiController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\WilayahProvinsiValidation();
    }

    /**
    * Lists all WilayahProvinsi models.
    * @return mixed
    */
    public function actionIndex()
    {
        $searchModel  = new WilayahProvinsiSearch;
    ...
    /**
    * Creates a new WilayahProvinsi model.
    ...
    */
    ...
    /**
    * Finds the WilayahProvinsi model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param string $id
    * @return WilayahProvinsi the loaded model
    * @throws HttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (($model = WilayahProvinsi::findOne($id)) !== null) {
            return $model;
        } else {
