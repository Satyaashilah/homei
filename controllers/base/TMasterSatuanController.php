...
use app\models\search\MasterSatuanSearch;
...
/**
 * TMasterSatuanController implements the CRUD actions for MasterSatuan model.
 **/
class TMasterSatuanController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\MasterSatuanValidation();
    }
