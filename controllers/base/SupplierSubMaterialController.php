...
/**
 * SupplierSubMaterialController implements the CRUD actions for SupplierSubMaterial model.
 **/
class SupplierSubMaterialController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\SupplierSubMaterialValidation();
    }

    /**
    * Lists all SupplierSubMaterial models.
    * @return mixed
    */
    public function actionIndex()
    {
        $searchModel  = new SupplierSubMaterialSearch;
    ...
    /**
    * Creates a new SupplierSubMaterial model.
    ...
    */
    ...
    /**
    * Finds the SupplierSubMaterial model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param integer $id
    * @return SupplierSubMaterial the loaded model
    * @throws HttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (($model = SupplierSubMaterial::findOne($id)) !== null) {
            return $model;
        } else {
