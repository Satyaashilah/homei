...
use app\models\search\SupplierOrderCartSearch;
...
/**
 * SupplierOrderCartController implements the CRUD actions for SupplierOrderCart model.
 **/
class SupplierOrderCartController extends \app\components\productive\DefaultActiveController
{
    ...
    public function __construct($id, $module, $config = [])
    {
        ...
        // $this->validation = new \app\validations\SupplierOrderCartValidation();
    }

    /**
    * Lists all SupplierOrderCart models.
    * @return mixed
    */
    public function actionIndex()
    {
        $searchModel  = new SupplierOrderCartSearch;
    ...
    /**
    * Creates a new SupplierOrderCart model.
    ...
    */
    ...
    /**
    * Finds the SupplierOrderCart model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param integer $id
    * @return SupplierOrderCart the loaded model
    * @throws HttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (($model = SupplierOrderCart::findOne($id)) !== null) {
            return $model;
        } else {
