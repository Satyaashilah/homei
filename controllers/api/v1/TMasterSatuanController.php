...
/**
 * This is the class for REST controller "TMasterSatuanController".
...
class TMasterSatuanController extends \app\modules\api\controllers\BaseController
{
    use \app\traits\MessageTrait;
    public $modelClass = 'app\models\MasterSatuan';
